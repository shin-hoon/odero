...
<body>
	<div class="container">
		<div class="row">
			<span class="text-center"><h3>문의 게시판</h3></span>
	...
	<div class="container text-center">
		<ul class="pagination">
       		<li><a href="qnaBoard.do?page=${curpage<11?curpage:curpage-10}">◀◀</a></li>
       		<li><a href="qnaBoard.do?page=${curpage<2?curpage:curpage-1}">◀</a></li>
       		...
       		<li><a href="qnaBoard.do?page=${curpage<totalpage?curpage+1:curpage}">▶</a></li>
